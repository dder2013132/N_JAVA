    ...
    private void showEquipInven(String[] userInfo, String[] equipInfo, String[] invenSelection, String log,
        ...
        for (int i = 0; i < 5; i++) {
            if (page * 5 + i < equips.size()) {
                String name = ConsoleUIUtils.leftText(equips.get(i)[0], 15);
                String atk = ConsoleUIUtils.centerText(equips.get(i)[1], 6);
                String reqlv = ConsoleUIUtils.centerText(equips.get(i)[2], 8);
                String equipped = ConsoleUIUtils.centerText(equips.get(i)[3], 5);
    ...
    private void showConsInven(String[] userInfo, String[] consInfo, String[] invenSelection, String log,
        ...
        for (int i = 0; i < 5; i++) {
            if (page * 5 + i < conss.size()) {
                String name = ConsoleUIUtils.leftText(conss.get(i)[0], 15);
                String atk = ConsoleUIUtils.leftText("체력 " + conss.get(i)[1] + "회복", 16);
                String reqlv = ConsoleUIUtils.leftText(conss.get(i)[2], 8);
